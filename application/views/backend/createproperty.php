...
-->
				...
				<div class=" form-group">
				  ...
				  <div class="col-sm-4">
					<?php 	 echo form_dropdown('age',$age,set_value('age'),'id="ageid" class="chzn-select form-control" 	data-placeholder="Choose a age..."');
					?>
				  </div>
				</div>
				...
				<div class=" form-group">
				  ...
				  <div class="col-sm-4">
					<?php 	 echo form_dropdown('luxury',$luxury,set_value('luxury'),'id="luxuryid" class="chzn-select form-control" 	data-placeholder="Choose a luxury..."');
					?>
				  </div>
				</div>
				...
				<div class=" form-group">
				  ...
				  <div class="col-sm-4">
					<?php 	 echo form_dropdown('residential',$luxury,set_value('residential'),'id="residentialid" class="chzn-select form-control" 	data-placeholder="Choose a residential..."');
					?>
				  </div>
				</div>
				...
				<div class=" form-group">
				  ...
				  <div class="col-sm-4">
					<?php 	 echo form_dropdown('kitchen',$luxury,set_value('kitchen'),'id="kitchenid" class="chzn-select form-control" 	data-placeholder="Choose a kitchen..."');
					?>
				  </div>
				</div>
				...
				<div class=" form-group">
				  ...
				  <div class="col-sm-4">
					<?php 	 echo form_dropdown('developmentnego',$luxury,set_value('developmentnego'),'id="developmentnegoid" class="chzn-select form-control" 	data-placeholder="Choose a developmentnego..."');
					?>
				  </div>
				</div>
				...
				<div class=" form-group">
				  ...
				  <div class="col-sm-4">
					<?php 	 echo form_dropdown('preferencialnego',$luxury,set_value('preferencialnego'),'id="preferencialnegoid" class="chzn-select form-control" 	data-placeholder="Choose a preferencialnego..."');
					?>
				  </div>
				</div>
				...
				<div class=" form-group">
				  ...
				  <div class="col-sm-4">
					<?php 	 echo form_dropdown('parkingnego',$luxury,set_value('parkingnego'),'id="parkingnegoid" class="chzn-select form-control" 	data-placeholder="Choose a parkingnego..."');
					?>
				  </div>
				</div>
				...
				<div class=" form-group">
				  ...
				  <div class="col-sm-4">
					<?php 	 echo form_dropdown('maintainancenego',$luxury,set_value('maintainancenego'),'id="maintainancenegoid" class="chzn-select form-control" 	data-placeholder="Choose a maintainancenego..."');
					?>
				  </div>
				</div>
				...
				<div class=" form-group">
				  ...
				  <div class="col-sm-4">
					<?php 	 echo form_dropdown('clubhousenego',$luxury,set_value('clubhousenego'),'id="clubhousenegoid" class="chzn-select form-control" 	data-placeholder="Choose a clubhousenego..."');
					?>
				  </div>
				</div>
				...
				<div class=" form-group">
				  ...
				  <div class="col-sm-4">
					<?php 	 echo form_dropdown('floorrisenego',$luxury,set_value('floorrisenego'),'id="floorrisenegoid" class="chzn-select form-control" 	data-placeholder="Choose a floorrisenego..."');
					?>
				  </div>
				</div>
				...
				<div class=" form-group">
				  ...
				  <div class="col-sm-4">
					<?php 	 echo form_dropdown('othernego',$luxury,set_value('othernego'),'id="othernegoid" class="chzn-select form-control" 	data-placeholder="Choose a othernego..."');
					?>
				  </div>
				</div>
				...
				<div class=" form-group">
				  ...
				  <div class="col-sm-4">
					<?php 	 echo form_dropdown('rentnego',$luxury,set_value('rentnego'),'id="rentnegoid" class="chzn-select form-control" 	data-placeholder="Choose a rentnego..."');
					?>
				  </div>
				</div>
				...
				<div class=" form-group">
				  ...
				  <div class="col-sm-4">
					<?php 	 echo form_dropdown('depositenego',$luxury,set_value('depositenego'),'id="depositenegoid" class="chzn-select form-control" 	data-placeholder="Choose a depositenego..."');
					?>
				  </div>
				</div>
