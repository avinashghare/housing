	    <section class="panel">
			...
			<div class="panel-body">
			  <form class="form-horizontal tasi-form" method="post" action="<?php echo site_url('site/editbuildersubmit');?>" enctype= "multipart/form-data">
				...
				<div class=" form-group">
				  ...
				  <a href="<?php echo site_url('site/viewbuilders'); ?>" class="btn btn-secondary">Cancel</a>
				</div>
				</div>
			  </form>
			</div>
